...
class ExitGroupConfirmationDialog extends StatelessWidget {
  final VoidCallback onExit;

  const ExitGroupConfirmationDialog({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Message
            AppText(
              text: AppString.exitGroupConfirmation,
              fontSize: 14.sp,
